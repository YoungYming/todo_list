...
(function () {
  ...
  function init() {
    ...
    if (!cfg || !cfg.epicId) return;

    var base = (typeof window.API_BASE !== 'undefined' ? window.API_BASE : '') || '';
    var epicId = cfg.epicId;
    var btnFetch = document.getElementById('btn-fetch-candidates');
    var btnSubmit = document.getElementById('btn-submit-split');
    ...
    var splitTaskEditor = document.getElementById('split-task-editor');
